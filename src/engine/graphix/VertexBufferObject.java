...
public class VertexBufferObject {
    ...
    /**
     * Binds this VBO with specified target. The target should
     ...
     * target should be <code>GL_ARRAY_BUFFER</code> and usage
     ...
     * The target should be <code>GL_ELEMENT_ARRAY_BUFFER</code>
