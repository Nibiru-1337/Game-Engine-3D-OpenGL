...
public class Renderer {
    ...
    private void setupShaderProgram() {
        ...
        /* Create FloatBuffer */
        vertices = MemoryUtil.memAllocFloat(4096); //TODO: change if out of memory
        ...
        vertexShader = Shader.loadShader(GL_VERTEX_SHADER, "src/resources/default.vert");
        fragmentShader = Shader.loadShader(GL_FRAGMENT_SHADER, "src/resources/default.frag");
